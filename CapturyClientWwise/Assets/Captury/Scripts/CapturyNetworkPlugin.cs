...
namespace Captury
{
	...
	public class CapturySkeleton
	{
		...
		public void UpdatePose()
		{
			...
			if (blendShapeActivations.Length != 0) {
				...
				foreach (SkinnedMeshRenderer renderer in renderers) {
					for (int i = 0; i < blendShapeActivations.Length; ++i)
		...
		/// <summary>
		/// Apply pose on the target skeleton for Riptide Networking
		/// </summary>
		public void UpdatePoseNetwork()
		{
			if (targetSkeleton == null || referenceSkeleton == null || poseGetter == null || poseSetter == null)
				return;
		...
		/// <summary>
		/// Extension of UpdatePoseNetwork
		/// </summary>
		/// <param name="pose"></param>
		void SendPoseData(HumanPose pose)
    	{
    	    Message message = Message.Create(MessageSendMode.Unreliable, (ushort) ClientToServerID.CapturyPose);
    	    message.AddVector3(pose.bodyPosition);
        	message.AddQuaternion(pose.bodyRotation);
        	message.AddFloats(pose.muscles);
		...
		public HumanPoseHandler poseGetter { get; private set; }
		private GameObject targetSkeleton = null; // the target skeleton
		public String targetName;
		public HumanPoseHandler poseSetter { get; private set; }
	}
	...
	public class CapturyNetworkPlugin : MonoBehaviour
	{
		...
		public readonly Dictionary<int, CapturySkeleton> skeletons = new();
